...
import { Check, ChevronRight, Code2, Globe, Cpu, ArrowUpRight, Instagram, Linkedin, Twitter, Mail } from 'lucide-react';
    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '32px' }}>
          ...
          <button onClick={onClose} style={{ background: 'transparent', border: '1px solid var(--border)', color: 'var(--text-muted)', width: '36px', height: '36px', borderRadius: '50%', cursor: 'pointer', fontSize: '1rem' }}>✕</button>
        </div>
        ...
        <div style={{ maxWidth: '1100px', position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 'var(--space-8)', alignItems: 'flex-start' }}>
            <motion.p
              ...
              animate={{ opacity: 1 }}
              transition={{ delay: 1 }}
              style={{ maxWidth: '480px', fontSize: '1.15rem', color: 'var(--text-muted)', lineHeight: 1.7 }}
            >
            ...
            <motion.div
              ...
              style={{ borderLeft: '2px solid var(--accent)', paddingLeft: 'var(--space-4)' }}
            >
          ...
          <motion.div
            ...
            style={{ marginTop: 'var(--space-8)', display: 'flex', gap: 'var(--space-3)' }}
          >
            ...
            {planes.map((p, i) => (
              <Reveal key={i} delay={i * 0.1}>
                <div className={`pricing-card ${p.destacado ? 'featured' : ''}`}>
                  ...
                  <button 
                    onClick={() => setPlanActive(p.nombre)}
